...
celery_app.conf.update(
    ...
    broker_transport_options={
        ...
        # Увеличиваем таймаут подтверждения для длительных задач (24 часа)
        # Это позволяет задачам работать бесконечно при manual_stop=True
        "consumer_timeout": 86400000,  # 24 часа в миллисекундах (для бесконечных задач)
        # Увеличиваем таймаут для чтения/записи сообщений (24 часа)
        "read_timeout": 86400,  # 24 часа в секундах
        "write_timeout": 86400,  # 24 часа в секундах
        # Увеличиваем таймаут для heartbeat (чтобы соединение не закрывалось)
